...
public class Triangulator {
    ...
    ////
    //List<Mesh> TriangulateConvexPolygon(List<Vector3> convexHullpoints) {
    ...
    //        triPoints[0] = convexHullpoints[0];
    //        triPoints[1] = convexHullpoints[i - 1];
    //        triPoints[2] = convexHullpoints[i];

    //        Mesh mesh = new Mesh();
    //        mesh.SetVertices(triPoints);
